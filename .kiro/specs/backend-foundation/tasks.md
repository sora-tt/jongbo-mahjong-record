...
- [ ] 1.2 Repository mapperとcanonical writeを統一する
...
- [ ] 1.4 League作成・更新のrule.uma合計0 validatorを実装する
...
- [ ] 1.5 (P) 必要なFirestore indexとデフォルト拒否Rulesを整備する
...
- [ ] 2.1 (P) ID Token交換とsession Cookie発行を固定する
...
- [ ] 2.2 保護APIのCookie認証とCORS境界を適用する
...
- [ ] 3.2 Runtime OpenAPI、Swagger、静的ドキュメントを同期する
...
- [ ] 3.3 正本契約に従うseedとEmulator検証を整備する
...
- [ ] 4.1 backend-integrity-lifecycleとfrontend-foundation-uiの契約再検証を通す
